...
\subsection*{Relevancia de la variable UPZ en el modelo reducido}
...
\subsection*{Análisis de variables no consideradas en el modelo reducido}
...
\subsection*{Reflexión sobre las variables enriquecidas y proyección de modelado sectorizado}
