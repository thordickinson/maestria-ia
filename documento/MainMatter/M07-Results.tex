...
El modelo optimizado obtuvo un RMSE promedio de 0.1584 (desviación estándar de 0.0082), un MAE de 0.1138 y un $R^2$ de 0.9600. En términos monetarios, el RMSE promedio fue de \$233 millones COP y el MAE de \$123 millones COP. Su desempeño se ubica entre el modelo base y el modelo enriquecido, lo que indica que la eliminación de variables geoespaciales redundantes reduce el ruido introducido por el modelo enriquecido, aunque no recupera completamente la precisión del modelo base. Las variables retenidas se muestran en la Tabla~\ref{tab:variables_optimizadas}.
