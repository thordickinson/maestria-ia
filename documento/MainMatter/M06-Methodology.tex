...
El conjunto de datos principal se obtuvo a partir de una recopilación pública de inmuebles publicada en 2024. Este dataset incluye información estructural como área, baños, parqueaderos, estrato, antigüedad, estado, administración y coordenadas geográficas. Para reducir la variabilidad tipológica y asegurar una mayor coherencia en las características modeladas, el análisis se restringió exclusivamente a apartamentos. Esta tipología presenta condiciones físicas y funcionales más uniformes, lo que facilita la identificación de patrones de valorización y reduce la complejidad del modelado. En contraste, otras categorías de inmuebles —como casas, locales comerciales u oficinas— exhiben una heterogeneidad considerable en atributos clave, incluyendo la relación entre área construida y área de lote, el número de niveles, la distribución interna, las restricciones de uso del suelo, la presencia o ausencia de áreas comunes y las especificaciones arquitectónicas o técnicas propias de cada uso. Estas diferencias generan dinámicas de mercado no comparables entre sí y producen variaciones estructurales difíciles de modelar de manera conjunta. Por ello, limitar el estudio a apartamentos permite trabajar con un conjunto de propiedades más homogéneo y obtener estimaciones más estables y fiables.
...
Las variables derivadas de POIs permitieron explorar la influencia del entorno urbano en la valoración inmobiliaria y analizar si la información geoespacial aportaba variación explicativa independiente, o si su efecto era absorbido por características con mayor peso, como el área o las coordenadas. La evaluación mediante importancias SHAP mostró una contribución marginal en la mayoría de casos. El enriquecimiento geoespacial sirvió así como base para la selección posterior de variables y la construcción del modelo optimizado.
